   ...
   <body onload="setTimeout('init(<?php echo "$mjpegmode, $video_fps, $divider" ?>);', 100);">
      ...
      <div class="container-fluid text-center liveimage">
         ...
         <div id="main-buttons">
            ...
            <input id="light_button" type="button" class="btn btn-primary" <?php getdisplayStyle('settings', $userLevel); ?>>
            <input id="door_button" type="button" class="btn btn-primary" <?php getdisplayStyle('settings', $userLevel); ?>>
         </div>
      </div>
