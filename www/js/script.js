...
ajax_status.onreadystatechange = function() {
  if(ajax_status.readyState == 4 && ajax_status.status == 200) {
    ...
    if(ajax_status.responseText == "ready") {
      ...
      document.getElementById("light_button").value = "Light On";
      document.getElementById("light_button").onclick = function() {send_cmd("onled");};
      document.getElementById("door_button").disabled = false;
      document.getElementById("door_button").value = "Open door";
      document.getElementById("door_button").onclick = function() {send_cmd("opendoor");};
